...
import DefaultReadinessCheckServiceImpl from "../backk/DefaultReadinessCheckServiceImpl";

@Module({
  imports: [],
  controllers: [AppController],
  providers: [
    { provide: ReadinessCheckService, useClass: DefaultReadinessCheckServiceImpl },
