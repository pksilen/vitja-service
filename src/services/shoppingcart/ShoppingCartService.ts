...
export default abstract class ShoppingCartService extends CrudResourceService {
  ...
  abstract removeFromShoppingCart(arg: _IdAndUserAccountIdAndSalesItemId): PromiseOfErrorOr<ShoppingCart>;
  abstract addToShoppingCart(arg: _IdAndUserAccountIdAndSalesItemId): PromiseOfErrorOr<ShoppingCart>;
