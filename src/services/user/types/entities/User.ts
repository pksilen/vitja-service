...
import FavoriteSalesItem from "../../../useraccount/types/entities/FavoriteSalesItem";
...
import { ArrayMaxSize, ArrayMinSize, IsPhoneNumber, MaxLength, IsEmail, IsAscii, IsString } from "class-validator"
